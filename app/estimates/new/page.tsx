...
import { getActiveOrganizationId, parseCurrencyInput } from '@/lib/org';
...
export default function NewEstimatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const totalNum = parseCurrencyInput(total);
    ...
    if (error) {
      ...
      setMessage(err instanceof Error ? err.message : 'Unable to save estimate.');
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="container">
      <AppNav />
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '1rem' }}>New Estimate</h1>
